  ...
  return (
    ...
    <link rel="manifest" href="/site.webmanifest" />
        ...
        <NextSeo
            ...
            canonical="https://mark2pdf.vercel.app"
            openGraph={{
                title: 'Convert your markdown to beautiful PDF in seconds - mark2pdf',
                description: 'Convert your markdown to beautiful PDF in seconds! Just paste your markdown markup and we will convert it to a PDF file.',
        ...
        <div className="flex flex-row items-center space-x-4">
          <a href="https://twitter.com/codewithsnowbit" target="_blank" rel="noopener noreferrer" >
          ...
          <Image src="https://avatars.githubusercontent.com/codewithsnowbit?s=30" alt="Dhairya Shah" className="rounded-full border-2 border-[#1DA1F2] p-[2px]" width={24} height={24}/>
