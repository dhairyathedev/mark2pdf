  ...
  return (
    <>
        ...
        <div className="flex flex-row items-center space-x-4">
          ...
          <Image src="https://avatars.githubusercontent.com/codewithsnowbit?s=30" alt="Dhairya Shah" class="rounded-full border-2 border-[#1DA1F2] p-[2px]" width={24} height={24}/>
